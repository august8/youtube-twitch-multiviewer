...
const features = [
  {
    icon: '📺',
    title: '複数配信の同時視聴',
    description: 'YouTube・Twitchの配信を同時に表示。画面は自動でグリッド配置されます。',
  },
  {
    icon: '💬',
    title: 'ライブチャット表示',
    description: '各配信のチャットを表示可能。ライブ配信やVODのチャットリプレイに対応。',
  },
  {
    icon: '⏱️',
    title: '再生時間の微調整',
    description: 'YouTube動画は±5秒/10秒のシークボタンで配信のズレを調整できます。',
  },
]
...
export function WelcomeScreen() {
  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-3xl mx-auto px-5 py-10 text-center">
      <h1 className="text-3xl font-bold mb-5 text-blue-400">🎬 YouTube / Twitch マルチビューア</h1>
